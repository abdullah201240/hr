...
export class AnnouncementsController {
  ...
  @Post()
  @Permissions('announcements:create')  // ← Gap G2 fix: only admin/hr can create announcements
  ...
  @Patch(':id')
  @Permissions('announcements:update')  // ← Gap G2 fix: only admin/hr can update announcements
  ...
  @Delete(':id')
  @Permissions('announcements:delete')  // ← Gap G2 fix: only admin/hr can delete announcements
