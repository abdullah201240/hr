    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-10 px-4 sm:px-6 lg:px-8 print:bg-white print:py-0 print:px-0 font-sans">
        ...
        <div className="print-document max-w-3xl mx-auto bg-white dark:bg-slate-950 p-12 sm:p-16 border border-slate-200 dark:border-slate-800 shadow-sm rounded-xl print:border-0 print:shadow-none print:p-0 print:pt-4">
          ...
          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-4 mb-6 leading-relaxed">
            <p className="font-bold text-blue-600 dark:text-blue-400 print:text-blue-600">Subject: Final Written Warning</p>
            <p>Dear Mr./Ms. {employeeLastName},</p>
            <p className="whitespace-pre-line">{letter.body}</p>
          </div>

          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-2 mb-6">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 print:text-blue-600">Details of Misconduct / Performance Concern</h3>
            <div className="space-y-1 pl-1">
              <p className="font-semibold font-sans">Date(s) of Incident: <span className="font-normal">{incidentDate}</span></p>
              <p className="font-semibold font-sans">Location: <span className="font-normal">{incidentLocation}</span></p>
              <p className="font-semibold font-sans mt-2">Description:</p>
              <p className="leading-relaxed whitespace-pre-wrap pl-2 border-l border-slate-200 dark:border-slate-800 print:border-black italic">
                {description}
          ...
          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-2 mb-6">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 print:text-blue-600">Previous Disciplinary Action</h3>
          ...
          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-2 mb-6 leading-relaxed">
            <h4 className="font-bold text-blue-600 dark:text-blue-400 print:text-blue-600">Policy / Rule Violated</h4>
          ...
          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-2 leading-relaxed mb-12">
            <h4 className="font-bold text-blue-600 dark:text-blue-400 print:text-blue-600">Required Corrective Action</h4>
            <p className="pl-1">
        ...
        <div className="print-document max-w-3xl mx-auto bg-white dark:bg-slate-950 p-12 sm:p-16 border border-slate-200 dark:border-slate-800 shadow-sm rounded-xl print:border-0 print:shadow-none print:p-0 print:pt-4 print:page-break-before">
          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-4 mb-12">
            <h3 className="font-bold text-blue-600 dark:text-blue-400 print:text-blue-600">Employee Support</h3>
            <p className="leading-relaxed">
        ...
        <div className="print-document max-w-3xl mx-auto bg-white dark:bg-slate-950 p-12 sm:p-16 border border-slate-200 dark:border-slate-800 shadow-sm rounded-xl print:border-0 print:shadow-none print:p-0 print:pt-4">
          ...
          <div className="text-xs text-slate-800 dark:text-slate-200 print:text-black space-y-2 mb-6">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-1">
              <li><span className="font-semibold font-sans">Effective Date:</span> {effectiveDate}</li>
              <li><span className="font-semibold font-sans">Suspension Period:</span> Until further written notice or completion of the investigation.</li>
