      ...
      return (
        <div className="space-y-6">
          <Card className="shadow-xs border-border/40 p-8 sm:p-12 bg-white text-slate-800 dark:bg-slate-950 dark:text-slate-200">
            ...
            <div className="text-xs space-y-4 mb-6 leading-relaxed">
              <p className="font-bold text-blue-600 dark:text-blue-400">Subject: Promotion and Revision of Compensation</p>
              <p>Dear Mr./Ms. {employeeLastName},</p>
              <p className="whitespace-pre-line">{letter.body}</p>
            </div>
              ...
              <div className="border rounded-md overflow-hidden border-slate-200 dark:border-slate-800">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-900 font-sans">
                    ...
                    <tr>
                      <td className="p-2 font-semibold bg-slate-50/50 dark:bg-slate-900/30">Grade</td>
                    ...
                    <tr className="font-semibold bg-slate-50/50 dark:bg-slate-900/30">
            ...
            <div className="text-xs space-y-2 mb-8">
              <h3 className="font-bold text-blue-600 dark:text-blue-400">Revised Monthly Salary Structure</h3>
              <div className="border rounded-md overflow-hidden border-slate-200 dark:border-slate-800">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-900 font-sans">
                    ...
                    <tr>
                      <td className="p-2 font-semibold bg-slate-50/50 dark:bg-slate-900/30">Other Allowance</td>
            ...
            <div className="text-xs space-y-4 mb-8 leading-relaxed">
              <div>
                <h4 className="font-bold text-blue-600 dark:text-blue-400">Terms</h4>
                <ul className="list-disc pl-5 mt-1 space-y-1">
